...
if __name__ == '__main__':
    ...
    transform_test = transforms.Compose([
                transforms.ToTensor(),])
    val_set    = torchvision.datasets.CIFAR100(root=args.data_dir, train=False , download=True, transform=transform_test)
    test_set_orig   = torchvision.datasets.CIFAR100(root=args.data_dir, train=False, download=True, transform=transform_test)
